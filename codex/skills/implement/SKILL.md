...
After every phase and checkpoint repair is complete, run complete repository verification on the exact clean candidate. Resolve failures before cumulative review, repeating focused work and complete verification until no implementation, repair, or check-settling work remains. Record the candidate commit, tree, command, and successful result.
