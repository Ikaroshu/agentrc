...
5. **Compare approaches.** Present 2-3 viable approaches with tradeoffs when genuine alternatives exist. Treat no change, documentation, accepting a limitation, or an operational workaround as viable approaches when they satisfy the intent. Prefer the approach that most directly and reliably delivers the required functionality, while keeping machinery and ongoing ownership proportional to its benefit. Lead with your recommendation and explain why it fits.
